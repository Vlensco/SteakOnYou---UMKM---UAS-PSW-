...
<body>
  ...
  @include('Resources.header2landing')

  <section id="home" class="slider-hero">
    <div class="hero-section item" style="background-image: url(assets/img/hero-1.jpg)">
      <div class="container">
        <div class="row align-items-end">
          <div class="col-xl-6">
            <div class="featured-area">
              <h2 style="color: yellow;">Steak On You</h1>
                <h2>The Perfect Space to Enjoy Fantastic Steak</h2>
                <h5>
                  The Best & Affordable Steak in Batam
                </h5>
                <div class="d-md-flex align-items-center">
                  <a href="#menu" class="button">See Our Menu</a>
                  <div class="video">
        ...
        <div class="col-xl-6">
          <div class="heading">
            <div data-aos="fade-right">
              <span>About The Restorant</span>
              <h2>The Best & Affordable Steak in Batam</h2>
            </div>
          </div>
        </div>
        <div class="col-xl-6">
          <div class="about-text">
            <div data-aos="fade-down">
              <p>
                Steak On You cabang Nagoya merupakan franchise dari Jambi yang sudah berdiri dari 5 November 2022. Steak
                On You didirikan karena adanya keinginan untuk berbagi makanan yang enak dengan harga yang terjangkau.
                Steak On You merupakan bisnis keluarga yang dijalankan oleh Mardian Alif dan Istrinya.
              </p>
            </div>
            <div class="mt-4 d-flex align-items-center">
              <img style="max-width: 500px; max-height: 100px;" alt="girl" src="assets/img/pemilik.jpg " />
              <div data-aos="fade-up-left">
                <h4>Mardian Alif</h4>
                <p>Owner Steak On You</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div data-aos="zoom-in">
            <div class="restaurant-card">
              ...
              <div class="restaurant-span">
                <span>Best Steak</span>
              </div>
              <div class="coctail-bar">
                <h5>Favorite Steak</h5>
                <p>
                  Steak On You memiliki menu andalan mereka yakni Grilled Beef Steak
                  Steak ini dibuat dengan menggunakan daging sapi khas yang dibakar hingga harum
                </p>
              </div>
            </div>
          </div>
          ...
          <div data-aos="zoom-in">
            <div class="restaurant-card coctail">
              ...
              <div class="coctail-bar">
                <h5>Place</h5>
                <p>
                  Steak On You Batam mempunyai dua cabang, yakni cabang pertamanya terletak di daerah Batam Center dan
                  cabang keduanya terletak di daerah Nagoya Permai.
                </p>
              </div>
            </div>
          </div>
          ...
          <div data-aos="zoom-in">
            <div class="restaurant-card">
              ...
              <div class="coctail-bar">
                ...
                <p>
                  Steak On You memiliki minuman andalan mereka yakni Lemon Punch
                  Minuman ini terbuat dari air lemon asli yang ditambahkan beberapa daun lemon
                </p>
              </div>
            </div>
          </div>
  ...
  <section id="menu" class="section-discover-menu">
    <div class="container">
      ...
      <div data-aos="zoom-in-up">
        <div class="nav nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          ...
          <button class="nav-link" id="v-pills-coffee-tab" data-bs-toggle="pill" data-bs-target="#v-pills-coffee"
            type="button" role="tab" aria-controls="v-pills-coffee" aria-selected="false">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
              y="0px" width="21.664px" height="21.665px" viewBox="0 0 21.664 21.665"
          ...
          <button class="nav-link" id="v-pills-pizza-tab" data-bs-toggle="pill" data-bs-target="#v-pills-pizza"
            type="button" role="tab" aria-controls="v-pills-pizza" aria-selected="false">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
              y="0px" width="305.934px" height="305.934px" viewBox="0 0 305.934 305.934"
    ...
    <div class="container">
      <div data-aos="fade-up" data-aos-anchor-placement="center-bottom">
        <div style="background-image: url(assets/img/patron.jpg)" class="reserve-table">
          <div class="row">
            <div class="col-xl-4">
              <div id="reserve" class="reserve-table-text">
                <h3>reserve A table</h3>
                <p>The Best & Affordable Steak In Batam</p>
              </div>
            </div>
            <div class="col-xl-8">
              <div class="best-food-restaurants">
                <form role="form" id="reservation-form" method="post">
                  <div class="row">
                    <div class="col-xl-6">
                      <input type="text" name="complete_name" placeholder="Complete Name" id="complete_name" />
                    </div>
                    <div class="col-xl-6">
                  ...
                  <div class="row">
                    <div class="col-xl-6">
                      <input type="number" name="no_of_guest" placeholder="No of Guest" id="no_of_guest" />
                    </div>
                    <div class="col-xl-6">
                      <div class="row">
                        <div class="col-xl-6">
                  ...
                  <button class="button" type="submit" id="submit">Reserve a Table</button>
                </form>
              </div>
            </div>
          </div>
        ...
        <div class="item col-xl-12">
          <div class="featured-dishes">
            <div class="featured-dishes-img">
              <img alt="featured-dishes" src="http://localhost/htdocs/adminsteakonyou/public/storage/theme/promo/<?php  echo $p->gambar_promo ?>" />
            </div>
            <ul class="star">
        ...
        <div class="col-xl-6">
          ...
          <div class="bratlee-slider owl-carousel owl-theme">
            ...
            <div class="bratlee-hamint item">
              <p>
                <?php  echo $f->review_feedback?>
              </p>
              <div class="d-flex align-items-center mt-4">
                <h3>
                  <?php  echo $f->nama_feedback?>
                </h3>
                <ul class="star">
                  <?php  if ($f->bintang_feedback == 5) { ?>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <?php  } elseif ($f->bintang_feedback == 4) { ?>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid "></i>
                  <?php  } elseif ($f->bintang_feedback == 3) { ?>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid "></i>
                  <i class="fa-solid "></i>
                  <?php  } elseif ($f->bintang_feedback == 2) { ?>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid "></i>
                  <i class="fa-solid "></i>
                  <i class="fa-solid "></i>
                  <?php  } elseif ($f->bintang_feedback == 1) { ?>
                  <i class="fa-solid fa-star"></i>
                  <i class="fa-solid "></i>
                  <i class="fa-solid "></i>
                  <i class="fa-solid "></i>
  ...
  <section id="order" class="gap no-bottom app-foods" style="background-color: #f5f8fd">
    <div class="container">
      <div class="row">
        <div class="col-xl-6">
          <div class="heading">
            <span>Available In Grab & Gojek</span>
            <h3>Manage Your Order Anytime! Anywhere!</h3>
          </div>
          <ul class="higher-reach">
            <li>
              <div class="bol"></div>
              Minimal Effort Order
            </li>
            <li>
              <div class="bol"></div>
          ...
          <div class="d-sm-flex mt-5">
            <a href="https://gofood.link/a/H6HiYoU" target="_blank">
              <div class="download-from" style="background-color: black">
                <svg xmlns="http://www.w3.org/2000/svg" width="60px" height="60px" viewBox="0 0 24 24">
                  <path fill="green" style="width: 10px; height: 10px;"
  ...
  <div class="gap no-top">
    <div style="background-image: url(assets/img/follow.jpg)" class="follow">
      <a href="https://www.instagram.com/steakonyoubatam/" target="_blank">
        <i class="fa-brands fa-instagram"></i>
      </a>
      <a href="https://www.instagram.com/steakonyoubatam/" target="_blank">
        <h2>Follow @steakonyoubatam</h2>
      </a>
      <p>For More & Update Information</p>
    </div>
  </div>
